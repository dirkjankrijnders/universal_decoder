...
import logging
import unittest
from decconf.protocols.loconet import LNCVConfirmedMessage, LNCVWriteMessage, writeModuleLNCV, readModuleLNCV, \
    startModuleLNCVProgramming, stopModuleLNCVProgramming, makeLNCVresponse, checksum_loconet_buffer, \
